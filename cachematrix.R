...
## The makeCacheMatrix function is storing a list of 4 functions (set, get, setinverse, & getinverse)
## The goal of the makeCacheMatrix is to create an object (a matrix), as well as cache its inverse
...
## The set function sets the value of a square matrix with data (y) and nrow/ncol (z)
    ...
    ## recalled or created in the cachSolve function.  This is logical since it should 
    ## not have a value until cached.
...
## The getinverse function calls the value from setinverse
...
makeCacheMatrix <- function(x = matrix()) {
        ...
        get <- function()x  # Get value of the matrix created with "set"
        setinverse <- function(solve) inverse <<- solve(x)  # Set value of the inverse matrix
        getinverse <- function() inverse   # Call value of the inverse
        #Store a list of the four functions as the final call of this function
...
## The cacheSolve function actually calculates the inverse of the square matrix defined by the 
...
cacheSolve <- function(x, ...) {
        ...
        inverse <- x$getinverse()  ## calling the inverse of object x stored in the 
                                   ## "getinverse" function
